...
def create_script_aware_prompt(premise, hypothesis, language_code):
    ...
    if script == "Arabic":
        return f""" You must decide the relationship using the target language first, and only then map it to English.
        
        INSTRUCTIONS:
        Step 1: Read the sentences and reason entirely in {lang}.
        Step 2: Choose the most appropriate decision word in {lang} that best describes the relationship.
        Step 3: Translate ONLY that chosen decision word into English and output it.
        Step 4: Output exactly ONE English word: entailment, contradiction, or neutral.
        
        Do NOT output explanations or any other text. Decision meanings:
        ...
        Final Answer (English, one word only):""".strip()
